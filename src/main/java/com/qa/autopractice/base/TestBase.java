package com.qa.autopractice.base;
...
public class TestBase {
	...
	public TestBase() throws IOException {
		...
		try {
			FileInputStream fis=new FileInputStream(System.getProperty("user.dir")+"/src/main/java/com/qa/autopractice/config/config.properties");
